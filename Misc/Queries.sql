...
user_login_date_time, org_id, user_alias, user_first_name, user_last_name, user_email_id, user_contact_no, user_enabled_yn, user_login_allowed_yn, user_login_fail_tries, bookie_access_yn, broker_access_yn, user_password) VALUES (
'2021-11-06 12:33:24.847166+05:30'::timestamp without time zone, 'd87005c6-9a10-41be-a83a-bdf8f52d3e90'::uuid, 'xjitenx'::character varying, 'Jitender'::character varying, 'Sharma'::character varying, 'jitender.gow@gmail.com'::character varying, '1231231231'::character varying, 'Y', 'Y', '0'::smallint, 'Y', 'N', 'poplol123'::character varying)
 returning user_id;
